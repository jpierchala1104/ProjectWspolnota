...
class ResolutionRecyclerViewAdapter(
    private val listener:(ResolutionItem)->Unit
) :
    RecyclerView.Adapter<ResolutionRecyclerViewAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.endDateView.text = "Zakończenie głosowania - ${item.finishDate}"
    }
    ...
    inner class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        val endDateView: TextView = view.date
    }
}